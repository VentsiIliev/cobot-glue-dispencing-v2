...
from PyQt6.QtWidgets import (
    ...
    QApplication, QTabWidget, QWidget, QStackedLayout
)

from pl_gui.customWidgets.CustomWarningDialog import CustomWarningDialog
from pl_gui.virtualKeyboard.VirtualKeyboard import FocusLineEdit
...
from pl_gui.Endpoints import QR_LOGIN, GO_TO_LOGIN_POS, UPDATE_CAMERA_FEED, START_CONTOUR_DETECTION, \
...
class MockCameraService:
    ...
    def handle(self, endpoint):
        if endpoint == QR_LOGIN:
            ...
            return print("Updating camera feed...")
        else:
            return Constants.RESPONSE_STATUS_ERROR


class MockCameraSystemController():
    def __init__(self):
    ...
    def handleLogin(self, username, password):
        if username == "12345" and password == "password":
            return "1"  # Simulate successful login
        return "0"  # Simulate failed login
...
if __name__ == "__main__":
    ...
    controller = MockCameraSystemController()
