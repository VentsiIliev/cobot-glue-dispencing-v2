...
from ..settings_view.CameraSettingsTabLayout import CameraSettingsTabLayout
from ..settings_view.ContourSettingsTabLayout import ContourSettingsTabLayout
from ..settings_view.RobotSettingsTabLayout import RobotSettingsTabLayout
from ..settings_view.GlueSettingsTabLayout import GlueSettingsTabLayout
...
class Controller:
    ...
    def handle(self, endpoint, *args):
        print(f"{self.logTag} [Method: handle] Endpoint called: '{endpoint}' with args: {args}")
