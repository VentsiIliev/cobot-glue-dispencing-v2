...
from pl_gui.gallery.GalleryContent import GalleryContent
from pl_gui.settings_view.SettingsContent import SettingsContent
from .ButtonConfig import ButtonConfig
from .Endpoints import *
from .Header import Header
from .Sidebar import Sidebar
from .controller.UserPermissionManager import UserPermissionManager
...
class MainWindow(QMainWindow):
    ...
    def logout(self):
        from pl_gui.LoginWindow import LoginWindow
