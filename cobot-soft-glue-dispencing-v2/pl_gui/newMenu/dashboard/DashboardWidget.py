...
from pl_gui.newMenu.dashboard.RobotTrajectoryWidget import SmoothTrajectoryWidget
...
from pl_gui.newMenu.dashboard.MachineIndicatorsWidget import MachineToolbar
