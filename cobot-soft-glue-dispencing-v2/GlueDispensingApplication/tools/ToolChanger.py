...
class ToolChanger():
    ...
    def __init__(self):
        ...
        self.slots = {
            10: {"position": [], "occupied": self.STATUS_OCCUPIED,"reservedFor": Gripper.BELT},
            11: {"position": [], "occupied": self.STATUS_OCCUPIED,"reservedFor": Gripper.SINGLE},
            ...
            14: {"position": [], "occupied": self.STATUS_OCCUPIED,"reservedFor": Gripper.MOCK4},
        }
    ...
    def getSlotIdByGrippedId(self, gripperId):
        ...
        # print("Can not find slot for gripper: ",gripperId)
        return None
...
if __name__ == "__main__":
    ...
    print("Gripper pickup positions for slot 0:", toolChanger.getGripperPickupPositions_0())
    print("Gripper drop off positions for slot 0:", toolChanger.getGripperDropoffPositions_0())
    print("Gripper pickup positions for slot 1:", toolChanger.getGripperPickupPositions_1())
    print("Gripper drop off positions for slot 1:", toolChanger.getGripperDropoffPositions_1())
    print("Gripper pickup positions for slot 2:", toolChanger.getGripperPickupPositions_2())
    print("Gripper drop off positions for slot 2:", toolChanger.getGripperDropoffPositions_2())
