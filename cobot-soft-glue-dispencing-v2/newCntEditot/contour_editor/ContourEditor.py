...
from pl_gui.contour_editor.SpacingDialog import SpacingDialog
from pl_gui.contour_editor.utils import shrink_contour_points
...
from pl_gui.contour_editor.SegmentSettingsWidget import default_settings
...
from newCntEditot.contour_editor.PointManagerWidget import PointManagerWidget
# from NewContourEditor.PointManager import PointManagerWidget
from pl_gui.CreateWorkpieceForm import CreateWorkpieceForm
...
class MainApplicationFrame(QFrame):
    ...
    def generateLineGridPattern(self):
        ...
        from pl_gui.contour_editor.utils import zigZag
